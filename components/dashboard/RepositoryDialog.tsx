            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="Enter a name for the repository" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                    ...
                    >
                      <CollapsibleTrigger asChild>
                        <div className="flex items-center justify-between p-2 cursor-pointer hover:bg-muted">
                          ...
                          <ChevronDown
                            className={`h-4 w-4 transition-transform ${languageOpen ? "transform rotate-180" : ""}`}
                          />
                        </div>
                      </CollapsibleTrigger>
...
<AnimatedContent>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription className="text-xs">Enter multiple directories , separated by commas</FormDescription>
                  <FormMessage />
           ...
           <AnimatedContent>
            <div className="flex justify-end pt-2">
              <Button type="submit" className="rounded-md">Import Repository</Button>
            </div>
            </AnimatedContent>
          </form>
        </Form>
